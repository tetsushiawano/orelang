...
int main(int argc, char **argv) {
  ...
  mpc_err_t* err = mpca_lang(MPCA_LANG_DEFAULT, STRUCTURE, Number, Factor, String, Ident, Term, Lexp, Let, Call, Stmts);
...
leave:
  mpc_cleanup(9, Number, Factor, String, Ident, Term, Lexp, Let, Call, Stmts);
  return 0;
}
